...
def insertPageNumbersAndAccountNumberAndHolderDetails():
    ...
    canvas.drawRightString(x=375, y=470, text=Account_Details[8])
    canvas.drawRightString(x=375, y=410, text=Account_Details[9])
    canvas.drawRightString(x=375, y=450, text=str(sum_positive))
    canvas.drawRightString(x=375, y=430, text=str(sum_negative))
